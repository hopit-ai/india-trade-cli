...
def recommend(
    ...
    if view_up == "BULLISH" and atm_ce_premium:
        ...
        results.append(StrategyResult(
            ...
            legs           = [{"action": "BUY", "type": "CE", "strike": atm_strike,
                               "premium": atm_ce_premium, "lots": 1}],
    ...
    if view_up == "BEARISH" and atm_pe_premium:
        ...
        results.append(StrategyResult(
            ...
            legs           = [{"action": "BUY", "type": "PE", "strike": atm_strike,
                               "premium": atm_pe_premium, "lots": 1}],
            capital_needed = round(cost, 2),
    ...
    if view_up == "BULLISH" and atm_ce_premium:
        ...
        results.append(StrategyResult(
            ...
            legs           = [
                {"action": "BUY",  "type": "CE", "strike": atm_strike, "premium": atm_ce_premium},
    ...
    if view_up == "BEARISH" and atm_pe_premium:
        ...
        results.append(StrategyResult(
            ...
            legs           = [
                {"action": "BUY",  "type": "PE", "strike": atm_strike,     "premium": atm_pe_premium},
                {"action": "SELL", "type": "PE", "strike": otm_put_strike,  "premium": otm_put_prem},
            ],
            capital_needed = round(net_debit * lot_size, 2),
            max_profit     = max_p,
            max_loss       = max_l,
...
def _get_atm_data(symbol: str, spot: float) -> tuple[float, float, float, int]:
    ...
    try:
        ...
        ce_prem = next(
            (c.last_price for c in chain
             if c.strike == atm and c.option_type.upper() == "CE"),
            None,
        )
        pe_prem = next(
            (c.last_price for c in chain
             if c.strike == atm and c.option_type.upper() == "PE"),
            None,
        )
