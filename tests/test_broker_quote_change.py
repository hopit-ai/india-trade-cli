...
class TestAngelOneQuoteChange:
    ...
    def test_change_computed_from_ltp_minus_close(self):
        b = self._make_broker({"ltp": 1304.6, "close": 1306.0, "open": 1295.0,
                                "high": 1308.3, "low": 1291.0, "tradedVolume": 1000})
    ...
    def test_change_positive_when_stock_up(self):
        b = self._make_broker({"ltp": 1310.0, "close": 1306.0, "open": 1295.0,
                                "high": 1315.0, "low": 1290.0, "tradedVolume": 500})
        q = b.get_quote(["NSE:RELIANCE"])["NSE:RELIANCE"]
    ...
    def test_other_fields_correct(self):
        b = self._make_broker({"ltp": 1304.6, "close": 1306.0, "open": 1295.0,
                                "high": 1308.3, "low": 1291.0, "tradedVolume": 28_000_000})
        q = b.get_quote(["NSE:RELIANCE"])["NSE:RELIANCE"]
...
class TestAngelOneHoldingsDayChange:
    ...
    def test_day_change_positive_when_stock_up(self):
        ...
        b = self._make_broker([{
            ...
            "quantity": 10, "averageprice": 1200.0,
            "ltp": 1310.0, "close": 1306.0,
        }])
        h = b.get_holdings()[0]
    ...
    def test_day_change_pct_computed(self):
        b = self._make_broker([{
            ...
            "quantity": 5, "averageprice": 1500.0,
            "ltp": 1530.0, "close": 1500.0,
        }])
        h = b.get_holdings()[0]
...
class TestUpstoxHoldingsDayChange:
    ...
    def test_day_change_from_api_field(self):
        b = self._make_broker([{
            "tradingsymbol": "RELIANCE", "isin": "INE002A01018",
            "exchange": "NSE",
            "quantity": 10, "average_price": 1200.0, "last_price": 1304.6,
            "day_change": -1.4, "day_change_percentage": -0.11,
        }])
        h = b.get_holdings()[0]
    ...
    def test_day_change_defaults_to_zero_gracefully(self):
        ...
        b = self._make_broker([{
            "tradingsymbol": "INFY", "isin": "INE009A01021",
            "exchange": "NSE",
            "quantity": 5, "average_price": 1500.0, "last_price": 1530.0,
